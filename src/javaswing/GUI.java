...
public class GUI extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == bhitung ){
          ...
          lpp.setText("Square Area         : "+String.valueOf(balok.Luas()));
          kpp.setText("Square Circumfrence : "+String.valueOf(balok.Keliling()));
          vb.setText("Cuboid Volume        : "+String.valueOf(balok.Volume()));
          lb.setText("Cuboid Surface Area  : "+String.valueOf(balok.Luas(vpanjang, vlebar, vtinggi)));       
          }
        } 
